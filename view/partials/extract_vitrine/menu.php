    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#about"><span>A PROPOS</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#why-us">Présentation</a></li>
              <li><a href="#why-us">Vision</a></li>
              <li><a href="#why-us">Mission</a></li>
              <li><a href="#why-us">valeur</a></li>
            </ul>
          </li>
          <li class="dropdown"><a href="#services"><span>NOS SERVICE</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#services">Développement personnel</a></li>
              <li><a href="#services">Prise de parole en public</a></li>
              <li><a href="#services">Leadership</a></li>
              <li><a href="#services">Négociation commerciale</a></li>
